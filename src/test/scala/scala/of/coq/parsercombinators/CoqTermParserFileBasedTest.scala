...
class CoqTermParserFileBasedTest extends FunSuite {
  ...
  test("""Testing "fun s => 5" """) {
    CoqTermParser(fileToString("FunFragment.v")) should parse(
      Fun(Binders(List(ExplicitSimpleBinder(Name(Some(Ident("s")))))), Number(5))
    )
  }

  test("""Testing "fun {A : Type} (l r : A) => r" """) {
    CoqTermParser(fileToString("FunImplicitParamsFragment.v")) should parse(
      Fun(
        Binders(
          List(
  ...
  test("""Testing "fun (A : Type) (_ b _ : A) => b" """) {
    CoqTermParser(fileToString("TemplateFunFragment.v")) should parse(
      Fun(
        Binders(
          List(
            ExplicitBinderWithType(List(Name(Some(Ident("A")))), Type),
            ExplicitBinderWithType(List(Name(None), Name(Some(Ident("b"))), Name(None)), Qualid(List(Ident("A"))))
          )
        ),
        Qualid(List(Ident("b")))
      )
  ...
  test("""Testing "let (l, r) return nat := Node 3 7 in sum l r" """) {
    CoqTermParser(fileToString("LetConstructorInFragment.v")) should parse(
  ...
  test(
    """Testing "let 'pair (pair l0 r0) (pair l1 r1) := pair (pair 3 5) (pair 7 10) return nat in sum (sum l0 r0) (sum l1 r1)" """
  ) {
              ...
              List(
                OrPattern(
                  List(
                    ConstructorPattern(
                      Qualid(List(Ident("pair"))),
                      List(QualidPattern(Qualid(List(Ident("l0")))), QualidPattern(Qualid(List(Ident("r0")))))
                    )
                  )
                )
              )
              ...
              List(
                OrPattern(
                  List(
                    ConstructorPattern(
                      Qualid(List(Ident("pair"))),
                      List(QualidPattern(Qualid(List(Ident("l1")))), QualidPattern(Qualid(List(Ident("r1")))))
                    )
                  )
                )
              )
          ...
          List(
            Argument(
              ...
              BetweenParenthesis(
                UncurriedTermApplication(
                  Qualid(List(Ident("pair"))),
                  List(Argument(None, Number(3)), Argument(None, Number(5)))
                )
              )
            ),
            Argument(
              ...
              BetweenParenthesis(
                UncurriedTermApplication(
                  Qualid(List(Ident("pair"))),
                  List(Argument(None, Number(7)), Argument(None, Number(10)))
                )
              )
            )
          )
          ...
          List(
            Argument(
              ...
              BetweenParenthesis(
                UncurriedTermApplication(
                  Qualid(List(Ident("sum"))),
                  List(Argument(None, Qualid(List(Ident("l0")))), Argument(None, Qualid(List(Ident("r0")))))
                )
              )
            ),
            Argument(
              ...
              BetweenParenthesis(
                UncurriedTermApplication(
                  Qualid(List(Ident("sum"))),
                  List(Argument(None, Qualid(List(Ident("l1")))), Argument(None, Qualid(List(Ident("r1")))))
                )
              )
            )
          )
  ...
  test("""Testing "if a then 5 else 7" """) {
    CoqTermParser(fileToString("IfFragment.v")) should parse(
            ...
            List(
              MultPattern(
                List(
                  ConstructorPattern(
                    Qualid(List(Ident("pair"))),
                    List(QualidPattern(Qualid(List(Ident("x")))), NumberPattern(Number(7)))
                  )
                )
              )
            ),
            ...
            List(
              MultPattern(
                List(
                  ConstructorPattern(
                    Qualid(List(Ident("pair"))),
                    List(UnderscorePattern, QualidPattern(Qualid(List(Ident("y")))))
                  )
                )
              )
            ),
  ...
  test(""" Testing
    ...
    CoqTermParser(fileToString("EmbeddedPatternMatchFragment.v")) should parse(
      Match(
        List(MatchItem(Qualid(List(Ident("k"))), None, None)),
        None,
        List(
          PatternEquation(List(MultPattern(List(NumberPattern(Number(0))))), Qualid(List(Ident("None")))),
          PatternEquation(
            List(
              MultPattern(
                List(ConstructorPattern(Qualid(List(Ident("S"))), List(QualidPattern(Qualid(List(Ident("k1")))))))
              )
            ),
            Match(
              List(MatchItem(Qualid(List(Ident("n"))), None, None)),
              None,
              List(
                PatternEquation(
                  List(MultPattern(List(NumberPattern(Number(0))))),
                  UncurriedTermApplication(Qualid(List(Ident("Some"))), List(Argument(None, Number(0))))
                ),
                PatternEquation(
                  List(MultPattern(List(NumberPattern(Number(1))))),
                  UncurriedTermApplication(Qualid(List(Ident("Some"))), List(Argument(None, Number(1))))
                ),
                PatternEquation(
                  List(MultPattern(List(QualidPattern(Qualid(List(Ident("n"))))))),
    ...
    CoqTermParser(fileToString("TwoItemsPatternMatchFragment.v")) should parse(
      Match(
        List(
          ...
          MatchItem(Qualid(List(Ident("Leaf"))), None, None)
        ),
        None,
        List(
          PatternEquation(
            List(
              MultPattern(List(QualidPattern(Qualid(List(Ident("Leaf")))), QualidPattern(Qualid(List(Ident("Leaf"))))))
            ),
            ...
            List(
              MultPattern(
                List(
                  ...
                  ConstructorPattern(
                    Qualid(List(Ident("Node"))),
                    List(UnderscorePattern, QualidPattern(Qualid(List(Ident("r")))))
                  )
                )
              )
            ),
    ...
    CoqTermParser(fileToString("NamedPatternMatchFragment.v")) should parse(
      Match(
        ...
        List(
          ...
          PatternEquation(
            List(MultPattern(List(QualidPattern(Qualid(List(Ident("c"))))))),
            UncurriedTermApplication(
              Qualid(List(Ident("Node"))),
              List(Argument(None, Qualid(List(Ident("Leaf")))), Argument(None, Qualid(List(Ident("Leaf")))))
            )
